...
var pictureListM = ["https://cdn.pixabay.com/photo/2018/06/13/18/20/wave-3473335_1280.jpg",
"https://cdn.pixabay.com/photo/2014/08/27/13/28/mother-429158_1280.jpg",
"https://cdn.pixabay.com/photo/2018/01/11/11/41/carnival-3075912_1280.jpg",
"https://images.unsplash.com/photo-1589666776877-01bb997251ec?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80",
"https://images.unsplash.com/photo-1468577760773-139c2f1c335f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1518998053901-5348d3961a04?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80",
"https://cdn.pixabay.com/photo/2019/09/06/19/43/grape-4457193_1280.jpg",
"https://cdn.pixabay.com/photo/2018/09/25/23/40/baukran-3703469_1280.jpg",
"https://cdn.pixabay.com/photo/2018/09/14/15/20/sisters-3677351_1280.jpg",
"https://images.unsplash.com/photo-1455655100973-2a0d5f567386?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"]
var wordListM = ["MARE", "MAMĂ", "MASCĂ", "MAXIM", "MARMELADĂ", "MUZEU", "MUST", "MACARA", "MOROCĂNOS", "MOȚ"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListM[++count % pictureListM.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListM[++indice % wordListM.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://images.unsplash.com/photo-1455655100973-2a0d5f567386?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80") {
            document.getElementById("mainbutton").innerHTML = "Play letter M again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
