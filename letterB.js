...
var pictureListB = ["https://images.unsplash.com/photo-1615485020471-b66207f5e3bb?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1489710437720-ebb67ec84dd2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1559669797-7c99e15e2b0d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
...
"https://cdn.pixabay.com/photo/2020/02/11/21/09/baker-4840960_1280.jpg",
"https://cdn.pixabay.com/photo/2017/02/13/05/44/rice-2061877_1280.jpg",
"https://cdn.pixabay.com/photo/2016/01/19/17/50/father-christmas-1149928_1280.jpg",
"https://cdn.pixabay.com/photo/2016/12/26/19/58/puddle-1932651_1280.jpg",
"https://images.unsplash.com/photo-1562179417-11897c0f06ff?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1551458874-80de15b86ce1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80"]
var wordListB = ["BĂȚ", "BUCURIE", "BARIERĂ", "BUSOLĂ", "BRUTAR", "BOB", "BARBĂ", "BALTĂ", "BULGARIA", "BOBOC"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListB[++count % pictureListB.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListB[++indice % wordListB.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://images.unsplash.com/photo-1551458874-80de15b86ce1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80") {
            document.getElementById("mainbutton").innerHTML = "Play letter B again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
