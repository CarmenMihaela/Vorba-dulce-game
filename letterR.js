...
var pictureListR = ["https://cdn.pixabay.com/photo/2018/10/14/23/13/mallard-3747770_1280.jpg",
"https://cdn.pixabay.com/photo/2015/06/23/18/08/peles-castle-818943_1280.jpg",
"https://cdn.pixabay.com/photo/2020/05/02/09/11/celandine-5120472_1280.jpg",
"https://images.unsplash.com/photo-1571489058415-1a62b15ce6f8?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1002&q=80",
"https://cdn.pixabay.com/photo/2016/05/28/19/22/myth-1422003_1280.jpg",
"https://cdn.pixabay.com/photo/2017/08/31/16/20/robot-2701312_1280.png",
"https://cdn.pixabay.com/photo/2014/10/05/06/05/rapeseeds-474558_1280.jpg",
"https://cdn.pixabay.com/photo/2015/02/01/18/00/fountain-619954_1280.jpg",
"https://cdn.pixabay.com/photo/2015/05/02/10/57/diamond-shaped-tiles-749768_1280.jpg",
"https://cdn.pixabay.com/photo/2017/02/06/12/34/reptile-2042906_1280.jpg"]
var wordListR = ["RAȚĂ", "ROMÂNIA", "ROSTOPASCĂ", "RATON", "RAZĂ", "ROBOT", "RAPIȚĂ", "ROATĂ", "ROMB", "REPTILĂ"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListR[++count % pictureListR.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListR[++indice % wordListR.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2017/02/06/12/34/reptile-2042906_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter R again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
