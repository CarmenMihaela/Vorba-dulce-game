...
var pictureListQ = ["https://cdn.pixabay.com/photo/2018/12/02/06/33/skyscrapers-3850732_1280.jpg",
"https://cdn.pixabay.com/photo/2015/01/08/18/29/entrepreneur-593358_1280.jpg",
"https://cdn.pixabay.com/photo/2017/04/24/17/25/frontenac-2257154_1280.jpg",
"https://cdn.pixabay.com/photo/2016/11/13/22/00/cinnamon-1822178_1280.jpg"]
var wordListQ = ["QATAR", "QUINTUS", "QUEBEC", "QUINOA"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListQ[++count % pictureListQ.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListQ[++indice % wordListQ.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2016/11/13/22/00/cinnamon-1822178_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter Q again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
