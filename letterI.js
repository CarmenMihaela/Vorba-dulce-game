...
var pictureListI = ["https://cdn.pixabay.com/photo/2017/12/03/22/11/winter-landscape-2995987_1280.jpg",
"https://cdn.pixabay.com/photo/2016/08/24/22/10/christ-1618197_1280.jpg",
"https://cdn.pixabay.com/photo/2016/01/19/14/55/bunny-1149060_1280.jpg",
"https://cdn.pixabay.com/photo/2014/08/08/20/53/ivy-413686_1280.jpg",
"https://images.unsplash.com/photo-1481016570479-9eab6349fde7?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80",
"https://cdn.pixabay.com/photo/2016/12/09/11/50/rainbow-1894743_1280.jpg",
"https://cdn.pixabay.com/photo/2018/07/13/21/03/monkey-3536548_1280.jpg",
"https://cdn.pixabay.com/photo/2016/11/23/18/10/architecture-1854130_1280.jpg",
"https://cdn.pixabay.com/photo/2013/02/05/19/16/swimming-78112_1280.jpg",
"https://cdn.pixabay.com/photo/2016/10/05/06/03/shakespeare-1716106_1280.jpg"]
var wordListI = ["IARNĂ", "ICOANĂ", "IEPURE", "IEDERĂ", "INVIZIBIL", "ÎNNORAT", "ÎNGÂMFAT", "ÎNALT", "ÎNOT", "ÎMPĂRAT"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListI[++count % pictureListI.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListI[++indice % wordListI.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2016/10/05/06/03/shakespeare-1716106_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter I again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
