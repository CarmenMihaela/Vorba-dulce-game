...
var pictureListP = ["https://cdn.pixabay.com/photo/2017/05/13/10/53/aegean-sea-2309286_1280.jpg",
"https://cdn.pixabay.com/photo/2017/12/11/11/30/helicopter-3011983_1280.jpg",
"https://cdn.pixabay.com/photo/2016/02/19/10/37/girls-1209321_1280.jpg",
"https://images.unsplash.com/photo-1471194395574-d150d0e0a97f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
...
"https://cdn.pixabay.com/photo/2014/09/15/12/16/pelicans-446864_1280.jpg",
"https://images.unsplash.com/photo-1558541344-8b8d57c9793d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1601593768799-7433c2447c29?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1567473030492-533b30c5494c?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"]
var wordListP = ["PESCAR", "ELICOPTER", "PĂR", "PĂR", "PLOAIE", "PLÂNS", "PELICAN", "PANSELE", "PORUMB", "PLIC"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListP[++count % pictureListP.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListP[++indice % wordListP.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://images.unsplash.com/photo-1567473030492-533b30c5494c?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80") {
            document.getElementById("mainbutton").innerHTML = "Play letter P again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
