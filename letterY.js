...
var pictureListY = ["https://cdn.pixabay.com/photo/2017/01/07/13/15/yoyo-1960314_1280.jpg",
"https://images.unsplash.com/photo-1593801626871-246f5957620a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
...
"https://cdn.pixabay.com/photo/2017/03/27/08/07/yen-2177672_1280.jpg"]
var wordListY = ["YOYO", "YALĂ", "YOGA", "HOBBY", "YEN"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListY[++count % pictureListY.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListY[++indice % wordListY.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2017/03/27/08/07/yen-2177672_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter Y again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
