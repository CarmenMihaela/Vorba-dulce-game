...
var pictureListN = ["https://cdn.pixabay.com/photo/2017/07/10/23/38/fuca-2491995_1280.jpg",
"https://cdn.pixabay.com/photo/2017/09/06/18/22/luck-2722470_1280.jpg",
"https://cdn.pixabay.com/photo/2016/10/13/22/52/walnuts-1739021_1280.jpg",
"https://cdn.pixabay.com/photo/2015/08/14/23/39/waterlily-889047_1280.jpg",
"https://cdn.pixabay.com/photo/2017/06/27/06/37/fishing-2446410_1280.jpg",
"https://cdn.pixabay.com/photo/2016/08/18/12/25/dog-1602840_1280.jpg",
"https://cdn.pixabay.com/photo/2016/04/18/22/05/seashells-1337565_1280.jpg",
"https://cdn.pixabay.com/photo/2018/02/10/09/35/animal-world-3143153_1280.jpg",
"https://images.unsplash.com/photo-1475609678816-d013f834a053?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://cdn.pixabay.com/photo/2016/04/28/13/54/daffodil-1358942_1280.jpg"]
var wordListN = ["NAS", "NOROC", "NUCĂ", "NUFERI", "NĂVOD", "NEGRU", "NISIP", "NUTRIE", "NOROI", "NARCISĂ"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListN[++count % pictureListN.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListN[++indice % wordListN.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2016/04/28/13/54/daffodil-1358942_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter N again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
