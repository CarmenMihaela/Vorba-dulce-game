...
var pictureListZ = ["https://cdn.pixabay.com/photo/2019/12/27/09/44/of-4722044_1280.jpg",
"https://cdn.pixabay.com/photo/2016/05/17/19/25/hyacinth-1398871_1280.jpg",
...
"https://images.unsplash.com/photo-1583771798701-e6da1c8be5ee?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1522448023466-b1c85da46df0?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://cdn.pixabay.com/photo/2016/11/01/13/20/fairy-tale-1788212_1280.jpg",
"https://cdn.pixabay.com/photo/2018/10/19/10/25/zebra-3758310_1280.jpg",
"https://cdn.pixabay.com/photo/2018/06/04/23/42/raspberry-3454504_1280.jpg",
"https://cdn.pixabay.com/photo/2017/03/01/21/56/kyte-2109716_1280.jpg",
"https://cdn.pixabay.com/photo/2019/03/11/23/05/chain-4049725_1280.jpg"]
var wordListZ = ["ZAR", "ZAMBILE", "ZÂMBET", "ZOO", "ZECE", "ZÂNĂ", "ZEBRĂ", "ZMEURĂ", "ZMEU", "ZA"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListZ[++count % pictureListZ.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListZ[++indice % wordListZ.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2019/03/11/23/05/chain-4049725_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter Z again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
