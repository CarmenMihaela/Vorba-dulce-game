...
var pictureListS = ["https://cdn.pixabay.com/photo/2015/01/15/17/47/slide-600597_1280.jpg",
"https://cdn.pixabay.com/photo/2015/06/22/08/37/children-817365_1280.jpg",
"https://images.unsplash.com/photo-1541199249251-f713e6145474?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80",
"https://cdn.pixabay.com/photo/2017/08/30/01/05/milky-way-2695569_1280.jpg",
"https://images.unsplash.com/photo-1560872236-a2550e4f2d4f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1010&q=80",
"https://images.unsplash.com/photo-1475470422741-f5bcb9e5db57?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1049&q=80",
"https://cdn.pixabay.com/photo/2019/08/22/19/09/odd-socks-4424190_1280.jpg",
"https://cdn.pixabay.com/photo/2011/07/25/23/40/green-tree-python-8343_1280.jpg",
"https://images.unsplash.com/photo-1571577275698-54f36820ee9b?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://cdn.pixabay.com/photo/2021/02/02/22/01/bridge-5975617_1280.jpg"]
var wordListS = ["SANIE", "SORĂ", "SUPĂRAT", "STELE", "SOLNIȚĂ", "ȘIREATĂ", "ȘOSETE", "ȘARPE", "ȘAPTE", "ȘINE"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListS[++count % pictureListS.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListS[++indice % wordListS.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2021/02/02/22/01/bridge-5975617_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter S again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
