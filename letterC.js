...
var pictureListC = ["https://cdn.pixabay.com/photo/2016/10/02/20/58/chestnut-1710430_1280.jpg",
"https://cdn.pixabay.com/photo/2017/01/13/09/23/magic-cube-1976725_1280.jpg",
"https://cdn.pixabay.com/photo/2015/10/19/00/24/crack-995370_1280.jpg",
"https://images.unsplash.com/photo-1457904375453-3e1fc2fc76f4?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://images.unsplash.com/photo-1534592302589-d4f8f14c6f47?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1056&q=80",
"https://cdn.pixabay.com/photo/2020/06/05/02/56/great-spotted-woodpecker-5261220_1280.jpg",
"https://cdn.pixabay.com/photo/2017/10/20/21/24/vendor-kiosk-2872915_1280.jpg",
"https://cdn.pixabay.com/photo/2017/05/05/10/57/tuscany-2286630_1280.jpg",
"https://cdn.pixabay.com/photo/2017/08/20/07/30/hammer-2660775_1280.jpg",
"https://cdn.pixabay.com/photo/2017/03/25/14/22/constanta-2173616_1280.jpg"]
var wordListC = ["CASTANE", "CUB", "CRĂPĂTURĂ", "CONTABIL", "CRISTAL", "CIOCĂNITOARE", "CHIOȘC", "CHIPAROȘI", "CIOCAN", "CONSTANȚA"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListC[++count % pictureListC.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListC[++indice % wordListC.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2017/03/25/14/22/constanta-2173616_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter C again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
