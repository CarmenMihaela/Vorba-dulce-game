...
var pictureListO = ["https://cdn.pixabay.com/photo/2019/05/10/00/02/oasis-4192473_1280.jpg",
"https://cdn.pixabay.com/photo/2016/07/28/17/00/dovetail-1548465_1280.jpg",
"https://cdn.pixabay.com/photo/2017/01/16/19/54/ireland-1985088_1280.jpg",
"https://images.unsplash.com/photo-1604971666408-9dcd56ece0bf?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80",
"https://cdn.pixabay.com/photo/2016/03/07/10/58/easter-egg-1241960_1280.jpg",
"https://cdn.pixabay.com/photo/2014/11/04/08/13/fly-agaric-516281_1280.jpg",
"https://cdn.pixabay.com/photo/2020/01/29/17/47/eyes-4803146_1280.jpg",
"https://images.unsplash.com/photo-1600474848646-0142057eb600?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
"https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1113&q=80",
"https://cdn.pixabay.com/photo/2017/02/05/20/37/face-2041148_1280.jpg"]
var wordListO = ["OAZĂ", "OMIDĂ", "OAIE", "OGLINDĂ", "OU", "OTRĂVITOARE", "OCHI", "OȚEL", "ORAȘ", "OBRAZ"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListO[++count % pictureListO.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListO[++indice % wordListO.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2017/02/05/20/37/face-2041148_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter O again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
