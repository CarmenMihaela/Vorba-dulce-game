...
var pictureListT = ["https://cdn.pixabay.com/photo/2017/06/23/18/29/old-linden-alley-2435494_1280.jpg",
"https://images.unsplash.com/photo-1523018560493-b4bb9620a572?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://cdn.pixabay.com/photo/2017/07/24/19/57/tiger-2535888_1280.jpg",
"https://cdn.pixabay.com/photo/2013/02/18/17/03/ax-82797_1280.jpg",
"https://cdn.pixabay.com/photo/2016/11/21/12/26/tunnel-1845046_1280.jpg",
"https://cdn.pixabay.com/photo/2018/06/18/23/03/europe-3483539_1280.jpg",
"https://cdn.pixabay.com/photo/2015/04/12/21/29/mosquito-719613_1280.jpg",
"https://cdn.pixabay.com/photo/2015/06/20/12/47/roof-815759_1280.jpg",
"https://cdn.pixabay.com/photo/2018/01/06/19/02/drop-3065629_1280.jpg",
"https://cdn.pixabay.com/photo/2016/05/31/18/20/rope-1427543_1280.jpg"]
var wordListT = ["TEI", "TIMIDĂ", "TIGRU", "TOPOR", "TUNEL", "ȚARĂ", "ȚÂNȚAR", "ȚIGLĂ", "ȚURȚURI", "ȚĂRUȘ"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListT[++count % pictureListT.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListT[++indice % wordListT.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2016/05/31/18/20/rope-1427543_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter T again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
