...
var pictureListE = ["https://cdn.pixabay.com/photo/2019/04/29/20/05/candy-bomber-4166926_1280.jpg",
"https://cdn.pixabay.com/photo/2021/03/12/23/50/girl-6090743_1280.jpg",
"https://cdn.pixabay.com/photo/2015/03/01/12/42/tag-654697_1280.jpg",
"https://cdn.pixabay.com/photo/2017/11/25/14/19/egret-2976899_1280.jpg",
"https://images.unsplash.com/photo-1610270066297-7b06341d2b8a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80",
"https://images.unsplash.com/photo-1573416104180-0db56402d03c?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1052&q=80",
"https://cdn.pixabay.com/photo/2017/10/30/17/44/eclairs-2903027_1280.jpg",
"https://cdn.pixabay.com/photo/2017/03/12/01/15/nuclear-2136244_1280.jpg",
"https://images.unsplash.com/photo-1542940689-466c7c6e7cd0?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1128&q=80",
"https://images.unsplash.com/photo-1604242684300-255b9250405d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"]
var wordListE = ["ELICE", "ELENA", "ETICHETĂ", "EGRETĂ", "ELIXIR", "EPAVĂ", "ECLER", "EXPLOZIE", "EPOLEȚI", "EȘARFĂ"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListE[++count % pictureListE.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListE[++indice % wordListE.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://images.unsplash.com/photo-1604242684300-255b9250405d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80") {
            document.getElementById("mainbutton").innerHTML = "Play letter E again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
