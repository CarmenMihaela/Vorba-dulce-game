...
var pictureListJ = ["https://images.unsplash.com/photo-1519669072050-a51e9a929312?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=740&q=80",
"https://images.unsplash.com/photo-1582058091505-f87a2e55a40f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
"https://cdn.pixabay.com/photo/2014/06/29/21/56/man-379800_1280.jpg",
"https://cdn.pixabay.com/photo/2017/05/04/10/37/steampunk-2283648_1280.jpg",
"https://cdn.pixabay.com/photo/2018/05/03/06/19/jaguar-3370498_1280.jpg",
"https://cdn.pixabay.com/photo/2012/11/28/11/24/judge-67715_960_720.jpg",
"https://cdn.pixabay.com/photo/2015/02/15/03/04/japanese-umbrellas-636870_1280.jpg",
"https://cdn.pixabay.com/photo/2015/07/28/22/04/female-865110_1280.jpg",
...
"https://cdn.pixabay.com/photo/2017/06/15/11/43/necklace-2405165_1280.jpg"]
var wordListJ = ["JOI", "JELEURI", "JENAT", "JOBEN", "JAGUAR", "JUDECĂTOARE", "JAPONIA", "JURNAL", "JACHETĂ", "JAD"]

//creating the count to loop through images list
var nextPic = (function() {
  var count = -1;
  return function() {
    return pictureListJ[++count % pictureListJ.length];
  }
}());
...
var nextWord = (function() {
  var indice = -1;
  return function() {
    return wordListJ[++indice % wordListJ.length];
  }
}());
    ...
    letter[i].onclick = function(event) {//when a letter mainbutton is clicked
      ...
      if (currentWord.includes(theLetter) && !correctLetters.includes(theLetter)) {//if the letter is in the word
        ...
        if (uniqueCorrectLetters.length == uniqueCleanWord.length){//if the length of the 2 unique arrays is equal,the winning word has been found
          ...
          if (document.getElementById("kidspic").src === "https://cdn.pixabay.com/photo/2017/06/15/11/43/necklace-2405165_1280.jpg") {
            document.getElementById("mainbutton").innerHTML = "Play letter J again"//the mainbutton shows play again
          }
          document.querySelector(".score").classList.add("glowbox");//adding glow to score
